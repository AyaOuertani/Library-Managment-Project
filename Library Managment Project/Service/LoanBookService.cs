    ...
    public class LoanBookService : ILoanBookService
    {
        ...
        public async Task<LoanBookResponse> LoanBook(LoanBookRequest loanBookRequest)
        {
            Book book = await _context.Book.
                                       FirstOrDefaultAsync(bookSelected => bookSelected.Code == loanBookRequest.BookCode);
            ...
            if(await _context.LoansBooks.
                              FirstOrDefaultAsync(loanBook=>loanBook.Book.Id==book.Id && 
            ...
            LoansBook loanBook =  new LoansBook()
            {
                ...
                DateOfReturn = DateTime.Now.AddMinutes(1),
